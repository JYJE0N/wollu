// English Short Sentences - Basic (no punctuation, no numbers)
export const basicEnglishShortSentences = [
  // Common proverbs
  ...
  "Rain falls gently on the ground",
  ...
  "Snow covers the earth in winter",
